...
namespace Accounts.Models
{
    ...
    public class AccountApiManager
    {
        ...
        public Tizen.Account.AccountManager.Account GetMyQAccount()
        {
        ...
        public bool CheckIfAccountAlreadyExists(UserCredentials accountItem)
        {
            try
            {
                var accounts = AccountService.GetAccountsAsync();
        ...
        public int GetAccountId(UserCredentials account)
        {
            try
            {
                ...
                var foundAccount = accounts.FirstOrDefault(
                    a => a.AccessToken == account.Password);
